...
export default function Cadastro() {
  ...
  return (
    <div className="w-full h-screen overflow-hidden bg-background">
      ...
      <iframe src={`/login/index.html?mode=register&captcha=${process.env.NEXT_PUBLIC_RECAPTCHA_SITE_KEY || ""}`} className="w-full h-full border-none outline-none" style={{ display: 'block' }} />
    </div>
  );
}
