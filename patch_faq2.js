...
if (content.match(sectionRegex)) {
  ...
  const logic = `
      ...
      faqBtns.forEach(btn => {
        // Remove old listeners to avoid duplicates on hot reload
  ...
  console.log("Regex did not match FAQ section!");
}
