...
// Find boundaries using indexOf
const startSearchString = '<section class="relative py-20 overflow-hidden"><div class="container mx-auto px-4"><div class="text-center mb-12" style="opacity:0;transform:translateY(50px)"><span class="text-xs uppercase tracking-[0.25em] text-primary font-medium">Dúvidas Frequentes</span>';
const startIndex = content.indexOf(startSearchString);

if (startIndex !== -1) {
  const nextSectionIndex = content.indexOf('</section>', startIndex);
  if (nextSectionIndex !== -1) {
    ...
    // Only add logic if not already added
